...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__n = 0U;
    if ((4U & (IData)(vlSelf->sel))) {
        vlSelf->sum = ((2U & (IData)(vlSelf->sel)) ? 
                       ((1U & (IData)(vlSelf->sel))
        ...
        vlSelf->sum = (0xfU & ((1U & (IData)(vlSelf->sel))
                                ? ((IData)(vlSelf->a) 
                                   & (IData)(vlSelf->b))
                                : (~ (IData)(vlSelf->a))));
    } else if ((1U & (IData)(vlSelf->sel))) {
        vlSelf->top__DOT__n = (0xfU & ((IData)(1U) 
                                       + (~ (IData)(vlSelf->b))));
        vlSelf->top__DOT__of = (1U & (((IData)(vlSelf->a) 
                                       + (IData)(vlSelf->top__DOT__n)) 
                                      >> 4U));
        vlSelf->sum = (0xfU & ((IData)(vlSelf->a) + (IData)(vlSelf->top__DOT__n)));
    } else {
        vlSelf->top__DOT__of = (1U & (((IData)(vlSelf->a) 
                                       + (IData)(vlSelf->b)) 
                                      >> 4U));
    ...
    vlSelf->of1 = vlSelf->top__DOT__of;
}
